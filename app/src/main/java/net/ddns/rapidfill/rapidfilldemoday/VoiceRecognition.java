...
public class VoiceRecognition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        result = findViewById(R.id.voice_result);
        tapToSpeak = findViewById(R.id.test_voice);
    ...
    public void getSpeedInput(View view) {
        ...
        if(intent.resolveActivity(getPackageManager()) != null) {
            ...
            Toast.makeText(this, "No speech support on this", Toast.LENGTH_SHORT).show();
        }
    }
